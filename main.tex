...
\textbf{Planning card} & \textbf{Debug log} & \textbf{Share card} \\
\midrule
...
For my own teaching, the most important design decision is that students are assessed on how intentionally they communicate meaning. That distinction matters for neurodivergent, culturally connected, multilingual, and mixed-identity students because it keeps literacy tied to agency. In this unit, joy is not separate from rigor: students still decompose, debug, revise, and explain, but those skills serve a world they care about.

\newpage
\section*{Appendix: Lesson Flow Figures}

\textbf{Design note:} These figures make the lesson sequence visible for teachers and students. Each one separates the student path, teacher support, and evidence so the unit can be followed without holding every step in working memory.

\begin{figure}[htbp]
\centering
\fcolorbox{LessonOneAccent}{LessonOneSoft}{%
\begin{minipage}{0.93\textwidth}
\textbf{\textcolor{LessonOneAccent}{Figure A1. Lesson 1 - Plan a Meaningful Place}}\\[0.05in]
\small
\begin{tabularx}{\textwidth}{>{\bfseries\raggedright\arraybackslash}p{0.22\textwidth} X}
Student path & Notice meaningful design; choose a real, imagined, symbolic, or future place; sketch 3--5 features; begin one prototype; explain one choice. \\
Teacher support & Model decomposition, protect private identity choices, offer role options, and keep the first build step visible. \\
Evidence & Planning card, prototype or sketch, partner explanation, and exit slip. \\
\end{tabularx}
\end{minipage}}
\end{figure}
...
\begin{figure}[htbp]
\centering
\fcolorbox{LessonTwoAccent}{LessonTwoSoft}{%
\begin{minipage}{0.93\textwidth}
\textbf{\textcolor{LessonTwoAccent}{Figure A2. Lesson 2 - Build, Code, and Debug}}\\[0.05in]
\small
\begin{tabularx}{\textwidth}{>{\bfseries\raggedright\arraybackslash}p{0.22\textwidth} X}
Student path & Choose one must-build feature and one try-to-code feature; build; test; notice a bug; revise; label what changed. \\
Teacher support & Normalize debugging, conference with short prompts, and connect technical changes back to meaning. \\
Evidence & Debug log, before/after note, screenshot label, and oral explanation. \\
\end{tabularx}
\end{minipage}}
\end{figure}
...
\begin{figure}[htbp]
\centering
\fcolorbox{LessonThreeAccent}{LessonThreeSoft}{%
\begin{minipage}{0.93\textwidth}
\textbf{\textcolor{LessonThreeAccent}{Figure A3. Lesson 3 - Share, Revise, and Reflect}}\\[0.05in]
\small
\begin{tabularx}{\textwidth}{>{\bfseries\raggedright\arraybackslash}p{0.22\textwidth} X}
Student path & Prepare a two-sentence share; present the world; collect one notice/wonder; revise for welcome or clarity; write the final reflection. \\
Teacher support & Provide sentence stems, protect choice, guide respectful feedback, and invite students to revise one small piece. \\
Evidence & Final screenshot or live view, peer feedback note, revision note, and exit reflection. \\
\end{tabularx}
\end{minipage}}
\end{figure}
