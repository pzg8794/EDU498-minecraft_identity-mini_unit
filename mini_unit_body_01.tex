...
\scriptsize\centering\textbf{Class 8 revision note:} New additions are shown in \textcolor{LessonTwoAccent}{blue}. This version adds backward-design alignment, a computer science disciplinary writing component, and standards connections to CSTA and New York State Computer Science and Digital Fluency expectations for grades 4--6.
\end{minipage}
\end{center}
...
\textbf{Task:} extend the Class 7 mini-unit by adding disciplinary literacy and skill development, especially through computer science writing, debugging documentation, and standards-aligned computational thinking.
