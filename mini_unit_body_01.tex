...
\hline
Student & Piter Zacari Garcia Bautista \\ \hline
Course & EDU498: Literacy Learning as Social Practice \\ \hline
Class Session & Class 8: Towards a Pursuit of Skills \\ \hline
Assignment & Asynchronous Activity 2: Disciplinary Literacy Mini-Unit Extension \\ \hline
Mini-Unit Focus & Minecraft world-building as identity, community, coding literacy, and disciplinary writing \\ \hline
Student Profile & Ethan, Student 5, Computer Science \\ \hline
Submission Date & June 2026 \\ \hline
\end{tabular}
\end{center}
...
\begin{tabularx}{\textwidth}{|>{\raggedright\arraybackslash}p{0.08\textwidth}|>{\raggedright\arraybackslash}p{0.86\textwidth}|}
\hline
\rowcolor{SoftBlue}
